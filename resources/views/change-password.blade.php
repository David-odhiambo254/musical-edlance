            ...
            <div class="col-lg-12">
                <div class="breadcrumb-contents">
                    ...
                    <ul class="breadcrumb-contents-list list-style-none">
                        <li class="breadcrumb-contents-list-item"> <a href="/change-password" class="breadcrumb-contents-list-item-link"> Home  </a> </li>
                        ...
                        {{-- <li class="profile-settings-menu-item ">
                            <a href="https://xilancer.xgenious.com/freelancer/wallet/withdraw/history"
                                ...
                                Withdraw History
                                                ...
                                                {{-- <li class="profile-settings-menu-item ">
                            <a href="https://xilancer.xgenious.com/freelancer/subscription/all"
                                class="profile-settings-menu-item-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="profile-settings-wrapper">
                            <form id="password_change_form">
                                <input type="hidden" name="_token" value="QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi" autocomplete="off">                                <style>
        button.close {
            width: 30px;
            height: 30px;
            border: none;
        ...
        <div class="toggle-password">
            ...
            <span class="hide-icon"><i class="fa-solid fa-eye"></i></span>
                                    ...
                                    <div class="btn-wrapper profile-border-top flex-btn justify-content-end">
                                        <button type="submit" class="btn-profile btn-bg-1">Change Password</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('keyup','#current_password',function(){
                ...
                $.ajax({
                    url: "https://xilancer.xgenious.com/freelancer/profile/check-password",
                    type: 'post',
            ...
            $('#password_change_form').on('submit',function(e){
                e.preventDefault();
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/profile/change-password",
                    method:'post',
                    ...
                    success:function(res){
                        ...
                        if(res.status=='success'){
                            ...
                            toastr_success_js("Password successfully changed.");
                        }
                        if(res.status=='not_match'){
                            toastr_warning_js("Password and confirm password not match.");
                        }
                        if(res.status=='current_pass_wrong'){
                            toastr_warning_js("Current password is wrong.");
                        }
                    },
                    error: function (err) {
