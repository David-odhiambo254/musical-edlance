                    ...
                    <div class="navbar-right-notification-wrapper-list">
                                      ...
                                      class="navbar-right-notification-wrapper-list-item click-notification">
                                                ...
                                                <div class="navbar-right-notification-wrapper-list-item-content">
                                                                ...
                                                                href="">
                                                            <span
                                                                    class="navbar-right-notification-wrapper-list-item-content-title">You have a new job proposal</span>
                                                        </a>
                                                        <span
                                                                class="navbar-right-notification-wrapper-list-item-content-time">Oct 17, 2024</span>
                                                                                                                                                                                                                                                                </div>
                                            </span>
                                                            <span href="javascript:void(0)"
                                      class="navbar-right-notification-wrapper-list-item click-notification">
                                                ...
                                                <div class="navbar-right-notification-wrapper-list-item-content">
                                                        ...
                                                        <span
                                                                class="navbar-right-notification-wrapper-list-item-content-time">Oct 9, 2024</span>
                                                                                                                                                                                                                                                                </div>
                                            </span>
                                                            <span href="javascript:void(0)"
                                      class="navbar-right-notification-wrapper-list-item click-notification">
                                                ...
                                                <div class="navbar-right-notification-wrapper-list-item-content">
                                                                                                                                                                                                                    <a
                                                                href="https://xilancer.xgenious.com/client/order/details/570">
                                                            <span
                                                                    class="navbar-right-notification-wrapper-list-item-content-title">Your order has been submitted. Please check it.</span>
                                                        </a>
                                                        <span
                                                                class="navbar-right-notification-wrapper-list-item-content-time">Oct 9, 2024</span>
                                                                                                                                                                                                            </div>
    ...
    <div class="navbar-author">
        ...
        <div class="navbar-author-wrapper">
            <div class="navbar-author-wrapper-list">
                                                            <a href="https://xilancer.xgenious.com/client/dashboard/info" class="navbar-author-wrapper-list-item">
...
<a href="https://xilancer.xgenious.com/client/order/all" class="navbar-author-wrapper-list-item">
    ...
    <a href="https://xilancer.xgenious.com/client/job/all" class="navbar-author-wrapper-list-item">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg">
            <path
...
<a href="https://xilancer.xgenious.com/client/live/all-offers" class="navbar-author-wrapper-list-item">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
         xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    My Offers
                        ...
                        <a href="https://xilancer.xgenious.com/client/job/create"
            ...
            <a href="https://xilancer.xgenious.com/client/profile/settings" class="navbar-author-wrapper-list-item">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
         xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-contents">
                    <h4 class="breadcrumb-contents-title"> Tickets </h4>
                    <ul class="breadcrumb-contents-list list-style-none">
                        <li class="breadcrumb-contents-list-item"> <a href="https://xilancer.xgenious.com" class="breadcrumb-contents-list-item-link"> Home  </a> </li>
                        <li class="breadcrumb-contents-list-item"> Tickets </li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="col-xl-3 col-lg-4">
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/dashboard/info" class="profile-settings-menu-item-link">
            ...
            Dashboard
                                        ...
                                        <li class="profile-settings-menu-item">
                    <a href="https://xilancer.xgenious.com/client/job/create" class="profile-settings-menu-item-link">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <li class="profile-settings-menu-item">
            <a href="https://xilancer.xgenious.com/client/job/all" class="profile-settings-menu-item-link">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <path
                            d="M16 22.7498H7.99998C3.37998 22.7498 2.51998 20.5998 2.29998 18.5098L1.54998 10.4998C1.43998 9.44977 1.40998 7.89977 2.44998 6.73977C3.34998 5.73977 4.83998 5.25977 6.99998 5.25977H17C19.17 5.25977 20.66 5.74977 21.55 6.73977C22.59 7.89977 22.56 9.44977 22.45 10.5098L21.7 18.4998C21.48 20.5998 20.62 22.7498 16 22.7498ZM6.99998 6.74977C5.30998 6.74977 4.14998 7.07977 3.55998 7.73977C3.06998 8.27977 2.90998 9.10977 3.03998 10.3498L3.78998 18.3598C3.95998 19.9398 4.38998 21.2498 7.99998 21.2498H16C19.6 21.2498 20.04 19.9398 20.21 18.3498L20.96 10.3598C21.09 9.10977 20.93 8.27977 20.44 7.73977C19.85 7.07977 18.69 6.74977 17 6.74977H6.99998Z"
        ...
        <li class="profile-settings-menu-item">
        <a href="https://xilancer.xgenious.com/client/order/all" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="profile-settings-menu-item">
        <a href="https://xilancer.xgenious.com/client/live/all-offers" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/wallet/history" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="profile-settings-menu-item  active ">
        <a href="https://xilancer.xgenious.com/client/support-ticket/ticket" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/reports/all" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/profile/-2fa" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/profile/change-password" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="profile-settings-menu-item ">
        <a href="https://xilancer.xgenious.com/client/profile/settings" class="profile-settings-menu-item-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
                        d="M12 15.75C9.93 15.75 8.25 14.07 8.25 12C8.25 9.93 9.93 8.25 12 8.25C14.07 8.25 15.75 9.93 15.75 12C15.75 14.07 14.07 15.75 12 15.75ZM12 9.75C10.76 9.75 9.75 10.76 9.75 12C9.75 13.24 10.76 14.25 12 14.25C13.24 14.25 14.25 13.24 14.25 12C14.25 10.76 13.24 9.75 12 9.75Z"
                                    ...
                                    <div class="single-profile-settings-contents">
                                        <div class="single-profile-settings-contents-upload">
                                            <div class="single-profile-settings-contents-upload-btn">
                                                <button class="btn-profile btn-bg-1" data-bs-toggle="modal" data-bs-target="#addModal">Add New Ticket</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <p>Notice: You can search here by ticket id, ticket status and ticket priority.</p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
                                    ...
                                    <div class="single-profile-settings-header-flex">
                                        <h4 class="single-profile-settings-header-title">All Tickets</h4> <br><br>
<p></p>
                                        <div class="search_wrapper">
    <span class="search_wrapper_icon"><i class="fa-solid fa-search"></i></span>
    <input type="text" placeholder="Search here" id="string_search"  class="form--control">
</div>
                                    </div>
                                </div>
...
<div class="deposit-history-pagination mt-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="https://xilancer.xgenious.com/client/support-ticket/ticket" method="POST">
    ...
    <input type="text" name="title" id="title" value="" step="" placeholder="Enter ticket title" class="form-control" >
</div>
                    <div class="single-input mb-3">
                        <label for="priority" class="label-title">Department</label>
                        <select name="department" id="department" class="form-control">
                            <option value="">Select Department</option>
                                                            <option value="2">Project Management</option>
                                                            <option value="3">Account Management</option>
                                                            <option value="7">Payment Management</option>
                                                    </select>
                    </div>
                    <div class="single-input mb-3">
                        <label for="priority" class="label-title">Priority</label>
    ...
    <label for="" class="label-title">Description</label>
    <textarea class="form-control summernote" name="description" id="description"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4 add_ticket">Create Ticket</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="footer-widget widget">
        ...
        <div class="footer-widget widget">
            ...
            <div class="footer-widget-inner mt-4">
                <ul class="footer-widget-link-list">
                                <li class="footer-widget-link-list-item">
                <a href="https://xilancer.xgenious.com/categories/design-and-creative">Design and Creative</a>
            </li>            <li class="footer-widget-link-list-item">
                <a href="https://xilancer.xgenious.com/categories/website-development">Website Development</a>
            </li>            <li class="footer-widget-link-list-item">
                <a href="https://xilancer.xgenious.com/categories/mobile-app-development">Mobile App Development</a>
            </li>            <li class="footer-widget-link-list-item">
                <a href="https://xilancer.xgenious.com/categories/digital-marketing">Digital Marketing</a>
            </li>            <li class="footer-widget-link-list-item">
                <a href="https://xilancer.xgenious.com/categories/writing-and-translation">Writing and Translation</a>
            </li>
                </ul>
            </div>
        </div>
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/client/support-ticket/pagination?page=" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/client/support-ticket/search",
                    method:'POST',
                    data:{string_search:string_search},
                    success:function(res){
