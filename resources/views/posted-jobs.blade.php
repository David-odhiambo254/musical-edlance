...
<ul class="sub-menu">
    ...
    <div class="profile-wrapper-flex flex-between">
        <div class="profile-wrapper-author-cotents">
            <h4 class="profile-wrapper-about-title mt-2"> <a href="/posted-jobs">Post a Job</a> </h4>
            <span class="profile-wrapper-about-para mt-2">Post a job to find and hire talents for your projects. </span>
        </div>
        <div class="profile-wrapper-right">
            <div class="btn-wrapper">
                                                            <a href="/posted-jobs" class="btn-profile btn-bg-1">Post a Job</a>
                                                </div>
        </div>
    </div>
</div>
...
<div class="tab-content-item-two active" id="job-postings">
    <div class="myJob-wrapper-tab mt-4">
        <div class="myJob-tabs">
            <ul class="tabs">
                <li data-tab="all-jobs" data-val="all" class="active jobs_filter_for_client"> All Jobs (1)</li>
                <li data-tab="active-jobs" data-val="active" class="jobs_filter_for_client"> Active Jobs (0)</li>
                <li data-tab="closed-jobs" data-val="close" class="jobs_filter_for_client"> Closed Jobs (0)</li>
                <li data-tab="completed-jobs" data-val="complete" class="jobs_filter_for_client"> Completed Jobs (0)</li>
            </ul>
        </div>
    </div>
</div>
...
<input type="hidden" id="set_filter_type_value" value="all">
    ...
    <div class="myJob-wrapper">
                                    <div class="myJob-wrapper-single job_open_close_location_41">
                    <div class="myJob-wrapper-single-flex flex-between align-items-center">
                        <div class="myJob-wrapper-single-contents">
                            <div class="flex-btn">
                                <span class="myJob-wrapper-single-id">#00041</span>
                                <div class="btn-item">
                                    <span class="myJob-wrapper-single-fixed">Fixed</span>
                                </div>
                                                                <div class="btn-item">
                                    <span
                                        class="myJob-wrapper-single-fixed active">Open
                                    </span>
                                </div>
                                                                                                                            </div>
                            ...
                            <div class="myJob-wrapper-single-list mt-3">
                                                                    <span class="job_publicPrivate_view">Public</span>
                                                                <div
                                    class="single-jobs-date mt-0">Oct 9, 2024
                                    - <span>Senior</span>
                                </div>
                                <span class="single-jobs-date mt-0">Proposals: 2</span>
                            </div>
                        </div>
                    </div>
                    <div class="flex-between profile-border-top">
                        <div class="btn-wrapper">
                            <a href="" class="job_open_close" data-job-id="41"
                                data-job-on-off="1">
                                                                    <span class="btn-profile btn-outline-cancel">Close Job</span>
                                                            </a>
                        </div>
                        <div class="btn-wrapper flex-btn gap-2">
                                                                                                <a href="" class="btn-profile btn-outline-gray">
                                        <i class="fa-regular fa-edit"></i>Edit Job
                                    </a>
                                                                                        <a href=""
                                class="btn-profile btn-bg-1">View Job</a>
                        </div>
                    </div>
                </div>
                        </div>
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.job_open_close', function(e) {
                ...
                if(job_on_off == 0){
                    title = "Are you sure to open this job?";
                    text = "If you open this job it will publicly visible and freelancer will send job proposal";
                    confirmation = "Yes, open it!";
                }else{
                    title = "Are you sure to close this job?";
                    text = "If you close this job it will not publicly visible and freelancer will not send job proposal";
                    confirmation = "Yes, close it!";
                }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"https://xilancer.xgenious.com/client/job/open/close",
                            method:"post",
                            data:{job_id:job_id},
                            success:function(res){
                                if(res.status == 1){
                                    $('.job_open_close_location_'+ job_id).load(mainPageUrl.href + ' .job_open_close_location_' + job_id)
                                    toastr_success_js("Job successfully open");
                                }else{
                                    $('.job_open_close_location_'+ job_id).load(mainPageUrl.href + ' .job_open_close_location_' + job_id)
                                    toastr_success_js("Job successfully closed")
                                }
                            }
                        })
                    }
            ...
            function histories(page,value){
                $.ajax({
                    url: "https://xilancer.xgenious.com/client/job/paginate/data?page=" + page,
                    data:{value:value},
                    success:function(res){
                        $('.search_result').html(res);
                    }
                });
                mainPageUrl.href = "https://xilancer.xgenious.com/client/job/paginate/data?page=" + page
            }
            ...
            $(document).on('click','.jobs_filter_for_client',function(){
                ...
                $.ajax({
                    url: "https://xilancer.xgenious.com/client/job/filter",
                    method:'POST',
                    data:{value:value},
                    success:function(res){
                        $('.search_result').html(res);
