...
<p></p>
    ...
    <tbody>
            ...
            <td>
                <a class="btn-sm btn-profile btn-bg-1" href="#">View Details</a>
            </td>
        </tr>
            <tr>
            <td>17</td>
            <td>البيت نالباتتة</td>
            <td>normal</td>
            <td>
                                    <span class="btn btn-sm btn-success" >Open</span>
                            </td>
            ...
            <tr>
            <td>7</td>
            <td>Test Ticket 2 from admin</td>
            <td>High</td>
            <td>
                                    <span class="btn btn-sm btn-danger" >Close</span>
                            </td>
            <td>
                <a class="btn-sm btn-profile btn-bg-1" href="#">View Details</a>
            </td>
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/support-ticket/pagination?page=" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/support-ticket/search",
                    method:'POST',
                    data:{string_search:string_search},
                    success:function(res){
