...
<head>
    ...
    <!-- favicon -->
                <link rel="icon" href="" sizes="40x40" type="icon/png">
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000570</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="#"> I will develop you an service based Flutter mobile app for Android and iOS </a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Deliver Order</span>
                                                                                                        </div>
                    </div>
                ...
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                ...
                                <h6 class="myOrder-single-block-title mt-2">$300.00
                    ...
                    <img src="https://xilancer.xgenious.com/assets/uploads/profile/1716788457-66541ce90456c.jpg" alt="AuthorImg">
            </a>
                        </div>
                        <div class="myOrder-single-block-item-content">
                                    <span class="myOrder-single-block-subtitle">Freelancer</span>
                         <i class="fas fa-circle-check"></i>        
        <h6 class="myOrder-single-block-title mt-1">Ryan Wayne
        ...
        <div class="custom_pagination mt-5" data-route="">
                        ...
                        <div class="profile-details-widget sticky_top_lg">
                            <div class="file-wrapper-item-flex flex-between align-items-center profile-border-bottom">
                                ...
                                <a href="/posted-job" class="profile-wrapper-item-browse-btn"> Browse All</a>
                            </div>
                                                                                                <div class="project-category-item radius-10">
                                        <div class="single-project project-catalogue">
                                            <div class="single-project-thumb">
                                                <a href="#">
                                                                                                            <img src="https://xilancer.xgenious.com/assets/uploads/project/1700027551-65545c9f71231.png" alt="Qixer service provider buyer mobile appp">
                                                                                                    </a>
                                            </div>
                                            ...
                                            <div class="project-category-item-bottom profile-border-top">
                                                <div class="project-category-item-bottom-flex flex-between align-items-center">
                                                    <div class="project-category-right-flex flex-btn">
                                                        <a href="#/" class="profile-wrapper-wishlist click-wishlist click_to_bookmark" data-identity = "110" data-type = "project"
            data-route = "#" >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M19.0703 22.75C18.5603 22.75 18.0003 22.6 17.4603 22.29L12.5803 19.58C12.2903 19.42 11.7203 19.42 11.4303 19.58L6.55031 22.29C5.56031 22.84 4.55031 22.9 3.78031 22.44C3.01031 21.99 2.57031 21.08 2.57031 19.95V5.86C2.57031 3.32 4.64031 1.25 7.18031 1.25H16.8303C19.3703 1.25 21.4403 3.32 21.4403 5.86V19.95C21.4403 21.08 21.0003 21.99 20.2303 22.44C19.8803 22.65 19.4803 22.75 19.0703 22.75ZM12.0003 17.96C12.4703 17.96 12.9303 18.06 13.3003 18.27L18.1803 20.98C18.6903 21.27 19.1603 21.33 19.4603 21.15C19.7603 20.97 19.9303 20.54 19.9303 19.95V5.86C19.9303 4.15 18.5303 2.75 16.8203 2.75H7.18031C5.47031 2.75 4.07031 4.15 4.07031 5.86V19.95C4.07031 20.54 4.24031 20.98 4.54031 21.15C4.84031 21.32 5.31031 21.27 5.82031 20.98L10.7003 18.27C11.0703 18.06 11.5303 17.96 12.0003 17.96Z" fill="#667085"></path>
                                                    ...
                                                    <div class="project-category-item-btn flex-btn">
                                                        <a href="#" class="btn-profile btn-outline-1"> Order Now </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-project project-catalogue">
                                            <div class="single-project-thumb">
                                                <a href="#">
                                                                                                            <img src="https://xilancer.xgenious.com/assets/uploads/project/1699164445-6547311def884.png" alt="I will build responsive WordPress website design and ecommerce website">
                                                                                                    </a>
                                            </div>
                                            <div class="single-project-content">
                                                <div class="single-project-content-top align-items-center flex-between">
                     ...
                     <a href="#/" class="single-project-orderCompleted"> 2 Orders Completed </a>
                                            ...
                                            <div class="project-category-item-bottom profile-border-top">
                                                <div class="project-category-item-bottom-flex flex-between align-items-center">
                                                    <div class="project-category-right-flex flex-btn">
                                                        <a href="#/" class="profile-wrapper-wishlist click-wishlist click_to_bookmark" data-identity = "108" data-type = "project"
            data-route = "https://xilancer.xgenious.com/freelancer/bookmark/project-job" >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.5 11.4H9.5C9.09 11.4 8.75 11.06 8.75 10.65C8.75 10.24 9.09 9.9 9.5 9.9H14.5C14.91 9.9 15.25 10.24 15.25 10.65C15.25 11.06 14.91 11.4 14.5 11.4Z" fill="#667085"></path>
                <path d="M12 13.96C11.59 13.96 11.25 13.62 11.25 13.21V8.21C11.25 7.8 11.59 7.46 12 7.46C12.41 7.46 12.75 7.8 12.75 8.21V13.21C12.75 13.62 12.41 13.96 12 13.96Z" fill="#667085"></path>
                <path d="M19.0703 22.75C18.5603 22.75 18.0003 22.6 17.4603 22.29L12.5803 19.58C12.2903 19.42 11.7203 19.42 11.4303 19.58L6.55031 22.29C5.56031 22.84 4.55031 22.9 3.78031 22.44C3.01031 21.99 2.57031 21.08 2.57031 19.95V5.86C2.57031 3.32 4.64031 1.25 7.18031 1.25H16.8303C19.3703 1.25 21.4403 3.32 21.4403 5.86V19.95C21.4403 21.08 21.0003 21.99 20.2303 22.44C19.8803 22.65 19.4803 22.75 19.0703 22.75ZM12.0003 17.96C12.4703 17.96 12.9303 18.06 13.3003 18.27L18.1803 20.98C18.6903 21.27 19.1603 21.33 19.4603 21.15C19.7603 20.97 19.9303 20.54 19.9303 19.95V5.86C19.9303 4.15 18.5303 2.75 16.8203 2.75H7.18031C5.47031 2.75 4.07031 4.15 4.07031 5.86V19.95C4.07031 20.54 4.24031 20.98 4.54031 21.15C4.84031 21.32 5.31031 21.27 5.82031 20.98L10.7003 18.27C11.0703 18.06 11.5303 17.96 12.0003 17.96Z" fill="#667085"></path>
                                        ...
                                        <div class="single-project project-catalogue">
                                            <div class="single-project-thumb">
                                                <a href="#">
                                                                                                            <img src="https://xilancer.xgenious.com/assets/uploads/project/1699186857-654788a9a99f5.png" alt="I will be your Facebook campaign manager to run Shopify Facebook ads">
                                                                                                    </a>
                                            </div>
                                            <div class="single-project-content">
                                                <div class="single-project-content-top align-items-center flex-between">
                    ...
                    <a href="#/" class="single-project-orderCompleted">No Order </a>
                                                ...
                                                <h4 class="single-project-content-title">
                                                    <a href="#"> I will be your Facebook campaign manager to run Shopify Facebook ads </a>
                                                </h4>
                                            </div>
                                            <div class="single-project-bottom flex-between">
                                                <span class="single-project-content-price">
                                            ...
                                            <div class="project-category-item-bottom profile-border-top">
                                                <div class="project-category-item-bottom-flex flex-between align-items-center">
                                                    <div class="project-category-right-flex flex-btn">
                                                        <a href="#/" class="profile-wrapper-wishlist click-wishlist click_to_bookmark" data-identity = "107" data-type = "project"
            data-route = "https://xilancer.xgenious.com/freelancer/bookmark/project-job" >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.5 11.4H9.5C9.09 11.4 8.75 11.06 8.75 10.65C8.75 10.24 9.09 9.9 9.5 9.9H14.5C14.91 9.9 15.25 10.24 15.25 10.65C15.25 11.06 14.91 11.4 14.5 11.4Z" fill="#667085"></path>
                <path d="M12 13.96C11.59 13.96 11.25 13.62 11.25 13.21V8.21C11.25 7.8 11.59 7.46 12 7.46C12.41 7.46 12.75 7.8 12.75 8.21V13.21C12.75 13.62 12.41 13.96 12 13.96Z" fill="#667085"></path>
...
<!--page script-->
    ...
    <script src="https://xilancer.xgenious.com/assets/frontend/js/mdb.min.js"></script>
    <script>
    (function($){
        "use strict";
        $(document).ready(function(){
            ...
            $(document).on('click','.request_for_order_revision',function(){
                ...
                if(description == ''){
                    toastr_warning_js("Please enter description.")
                    return false;
                }
            });
            ...
            $(document).on('click','.accept_and_pay',function(e){
                ...
                Swal.fire({
                    title: 'Accept Order ?',
                    text: 'If you accept freelancer will get the amount and you will not be able to change it.',
                    icon: 'warning',
            ...
            $(document).on('click','.active_this_milestone',function(e){
                ...
                Swal.fire({
                    title: 'Are you sure ?',
                    text: 'To activate this milestone.',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
            ...
            $(document).on('click','.order_sort',function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/client/order/sort/by/type",
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/client/order/paginate/data?page=" + page,
                    data:{order_type:order_type},
                    success:function(res){
                        $('.search_result').html(res);
                    }
