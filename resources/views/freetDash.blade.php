...
<p></p>
                                        ...
                                        <div>
                                            <select class="btn-profile btn-bg-1" onchange="switchProfile(this.value)">
                                                                                                    <option value="freelancer" selected  class="d-none" >Acting as Freelancer</option>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-sm-6 col-md-4">
                                            <div class="myJob-wrapper-single-balance total_balance">
                                                <div class="myJob-wrapper-single-balance-contents">
                                                    <div class="myJob-wrapper-single-balance-price d-flex gap-2 justify-content-between">
                                                        <h4 class="contract_single__balance-price">$1,330.60</h4>
                                                    </div>
                                            ...
                                            <a href="/profile-Details">
                                                <div class="myJob-wrapper-single-balance">
                                                    <div class="myJob-wrapper-single-balance-contents">
                                                        <div class="myJob-wrapper-single-balance-price d-flex gap-2 justify-content-between">
                                                            <h4 class="contract_single__balance-price">25</h4>
                                                        </div>
                                                        <p class="myJob-wrapper-single-balance-para">Total Projects</p>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <div class="myJob-wrapper-single-balance">
                                                <div class="myJob-wrapper-single-balance-contents">
                                                    <div class="myJob-wrapper-single-balance-price d-flex gap-2 justify-content-between">
                                                        <h4 class="contract_single__balance-price">19</h4>
                                                    </div>
...
<p></p>
                                        <a href="/my-orders" class="btn-profile btn-bg-1"> All Orders </a>
                                    </div>
                                </div>
                                <div class="single-profile-settings-inner profile-border-top">
                                    ...
                                    <div class="single-profile-settings-header">
                                        <div class="single-profile-settings-header-flex">
                                            <h4 class="single-profile-settings-header-title">Latest Projects</h4> <br><br>
<p></p>
                                            <a href="#" class="btn-profile btn-bg-1"> All Projects </a>
                                        </div>
                                    </div>
                                    <div class="single-profile-settings-inner profile-border-top">
                                        <div class="custom_table style-04">
                                            <table>
                                                ...
                                                <tbody>
                                                                                                    <tr>
                                                        <td>Rtttttttttttttt ggffffftfffffffttftfttttttttttt</td>
                                                        <td>
                                                            <a href="#" class="btn-profile btn-bg-1 edit_info_show_hide"> Edit Project </a>
                                                        </td>
                                                    </tr>
                                                                                                    <tr>
                                                        <td>Testdesigb sites write</td>
                                                        <td>
                                                            <a href="#" class="btn-profile btn-bg-1 edit_info_show_hide"> Edit Project </a>
                                                        </td>
                                                    </tr>
                                                                                                    <tr>
                                                        <td>والله مش عارف والله، لاه</td>
                                                        <td>
                                                            <a href="#" class="btn-profile btn-bg-1 edit_info_show_hide"> Edit Project </a>
                                                        </td>
                                                    </tr>
                                                                                                    <tr>
                                                        <td>https://bostake.co.in</td>
                                                        <td>
                                                            <a href="#" class="btn-profile btn-bg-1 edit_info_show_hide"> Edit Project </a>
                                                        </td>
                                                    </tr>
                                                                                                    <tr>
                                                        <td>i will create a great AI potrait of you</td>
                                                        <td>
                                                            <a href="#" class="btn-profile btn-bg-1 edit_info_show_hide"> Edit Project </a>
                                                        </td>
                                                    </tr>
...
<!--page script-->
    <script>
        function switchProfile(role) {
            $.ajax({
                url:"https://xilancer.xgenious.com/freelancer/dashboard/switch-profile",
                method:'post',
                data:{role:role},
                success:function(res){
                    if(res.status=='success'){
                        if(res.user_role == 'freelancer'){
                            window.location.href = "https://xilancer.xgenious.com/freelancer/dashboard/info";
                        }
                        if(res.user_role == 'client'){
                            window.location.href = "https://xilancer.xgenious.com/client/dashboard/info";
                        }
                        // location.reload();
                    }
                }
