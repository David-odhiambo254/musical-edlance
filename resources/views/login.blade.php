    ...
    <div class="navbar-author">
        <a href="javascript:void(0)" class="navbar-author-flex flex-btn navbar-author-link">
            <div class="navbar-author-thumb">
                                                            <img src="https://xilancer.xgenious.com/assets/uploads/profile/1680500462-642a66ee548e7.jpg" alt="profile img">
                                                </div>
                ...
                <div class="col-lg-5">
                    <div class="login-wrapper">
                        <div class="login-wrapper-contents">
                            <h3 class="login-wrapper-contents-title">Please login to continue</h3>
                            <style>
        button.close {
            width: 30px;
            height: 30px;
                            ...
                            <form class="login-wrapper-contents-form custom-form" id="user_auto_login_form" method="get" action="/clientlog">
                                ...
                                <div class="single-input mt-4">
                                    ...
                                    <div class="single-input-inner">
                                        <input class="form--control" type="password" name="password" id="password" placeholder="Type Password">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody style="border-top: none;">
                                            <tr>
                                                ...
                                                <td><form action="/freelancelog"><button class="autoLogin" id="freelancerLogin">Freelancer Login</button></form></td>
                                            </tr>
                                            <tr>
                                                <td id="client_username">client</td>
                                                <td id="client_password">12345678</td>
                                                <td><form action="/clientlog" ><button class="autoLogin" id="clientLogin">Client Login</button></form></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
