...
<div class="col-xl-3 col-lg-4">
    ...
    <li class="profile-settings-menu-item ">
        <a href="/clientlog" class="profile-settings-menu-item-link">
            ...
            <li class="profile-settings-menu-item">
            <a href="/posted-jobs" class="profile-settings-menu-item-link">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <path
                            d="M16 22.7498H7.99998C3.37998 22.7498 2.51998 20.5998 2.29998 18.5098L1.54998 10.4998C1.43998 9.44977 1.40998 7.89977 2.44998 6.73977C3.34998 5.73977 4.83998 5.25977 6.99998 5.25977H17C19.17 5.25977 20.66 5.74977 21.55 6.73977C22.59 7.89977 22.56 9.44977 22.45 10.5098L21.7 18.4998C21.48 20.5998 20.62 22.7498 16 22.7498ZM6.99998 6.74977C5.30998 6.74977 4.14998 7.07977 3.55998 7.73977C3.06998 8.27977 2.90998 9.10977 3.03998 10.3498L3.78998 18.3598C3.95998 19.9398 4.38998 21.2498 7.99998 21.2498H16C19.6 21.2498 20.04 19.9398 20.21 18.3498L20.96 10.3598C21.09 9.10977 20.93 8.27977 20.44 7.73977C19.85 7.07977 18.69 6.74977 17 6.74977H6.99998Z"
    ...
    <div class="single-profile-settings-flex">
        ...
        <div class="single-profile-settings-contents">
            ...
            <p class="single-profile-settings-contents-para mt-2">Profile photo recomended size 80x80 pixels</p>
        </div>
    </div>
</div>
...
<p></p>
            <div class="btn-wrapper">
                <a href="" class="btn-profile btn-outline-gray profile-click"><i
...
<form id="edit_profile_form" method="post">
    ...
    <span class="city_info"></span>
            ...
            <div class="popup-contents-btn flex-btn profile-border-top justify-content-end">
                <a href="javascript:void(0)" class="btn-profile btn-outline-gray btn-hover-danger color-one popup-close"> Cancel </a>
    ...
    <div class="footer-widget widget">
        ...
        <div class="footer-widget widget">
            ...
            <div class="footer-widget-inner mt-4">
                ...
                <a href="#t">Mobile App Development</a>
            </li>            <li class="footer-widget-link-list-item">
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('submit','#profile_photo_change',function(e){
                e.preventDefault();
                $.ajax({
                    url:"https://xilancer.xgenious.com/client/profile/edit-profile-photo",
                    method:'post',
            ...
            $(document).on('submit','#edit_profile_form',function(e){
                ...
                if(first_name == '' || last_name == '' || email == '' || country == ''){
                    ...
                    $.ajax({
                        url: "https://xilancer.xgenious.com/client/profile/edit-profile",
                        type: 'post',
                        data: {
