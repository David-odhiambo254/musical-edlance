                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="profile-settings-wrapper">
                            <form method="post" action="">
                                <input type="hidden" name="_token" value="QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi" autocomplete="off">                                <div class="single-profile-settings">
                                    <h4>Delete Account</h4>
                                    <div class="change-password custom-form mt-5">
                                        <div class="alert alert-warning " role="alert">
    <p>Notice: Remember you will not able to login this account after delete your account.</p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
