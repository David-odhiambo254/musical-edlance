...
<ul class="sub-menu">
                                ...
                                <div class="chat-wrapper-contact">
                                    <div class="chat-wrapper-contact-close">
                                        ...
                                        <ul class="chat-wrapper-contact-list">
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="1">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                                            <img src="https://xilancer.xgenious.com/assets/uploads/profile/1680500462-642a66ee548e7.jpg" alt="Andrew Fateh">
                                                </a>
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Andrew Fateh</a></h4>
                <span class="chat-wrapper-contact-list-time">2 hours ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para">Html Designer</p>
                <div class="unseen_message_count_1">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="2">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
                            </a>
            <div class="notification-dots "></div>
        </div>
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Istiak Ahmed</a></h4>
                <span class="chat-wrapper-contact-list-time">4 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_2">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="407">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Nina Kurasaki</a></h4>
                <span class="chat-wrapper-contact-list-time">1 month ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_407">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="450">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">LongNV LongNV</a></h4>
                <span class="chat-wrapper-contact-list-time">5 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_450">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="486">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Nihal Mammad Nihal Mammad</a></h4>
                <span class="chat-wrapper-contact-list-time">5 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_486">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="519">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">sandra condori chara sandra condori chara</a></h4>
                <span class="chat-wrapper-contact-list-time">5 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_519">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="532">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Jungin Park Jungin Park</a></h4>
                <span class="chat-wrapper-contact-list-time">4 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_532">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="568">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Mikhail Lushnikov Mikhail Lushnikov</a></h4>
                <span class="chat-wrapper-contact-list-time">4 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_568">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="631">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">nas sim nas sim</a></h4>
                <span class="chat-wrapper-contact-list-time">3 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_631">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="637">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">WMH COMMUNITY WMH COMMUNITY</a></h4>
                <span class="chat-wrapper-contact-list-time">3 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_637">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="638">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">Imran Ahmed Imran Ahmed</a></h4>
                <span class="chat-wrapper-contact-list-time">3 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_638">
                                    </div>
                                                                                            ...
                                                                                            <li class="chat-wrapper-contact-list-item chat_item" data-client-id="660">
    <div class="chat-wrapper-contact-list-flex">
        <div class="chat-wrapper-contact-list-thumb">
            <a href="javascript:void(0)">
                                    <img src="https://xilancer.xgenious.com/assets/static/img/author/author.jpg" alt="author">
        ...
        <div class="chat-wrapper-contact-list-contents">
            <div class="chat-wrapper-contact-list-contents-flex flex-between">
                <h4 class="chat-wrapper-contact-list-contents-title"><a href="javascript:void(0)">moha moha</a></h4>
                <span class="chat-wrapper-contact-list-time">3 months ago</span>
            </div>
            <div>
                <p class="chat-wrapper-contact-list-contents-para"></p>
                <div class="unseen_message_count_660">
                                    </div>
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <span class="dropMedia__file" id="uploadImage">
                                                        <i class="fa-solid fa-paperclip"></i> Attach Files
                                                                                                                                                            ...
                                                                                                                                                            <a href="javascript:void(0)" class="btn-profile btn-bg-1" id="freelancer-send-message-to-client">Send Message</a>
                                                                                                                                                </div>
                                                                                            <div class="chat-wrapper-details-footer-btn-right">
                                                    <small>Supported files: png, jpg, jpeg, gif, pdf, doc, docx, txt, csv, xlsx, xls, ppt, pptx, zip</small>
                                                </div>
                                                                                    </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi" autocomplete="off">                    <input type="hidden" name="client_id" id="client_id">
    ...
    <p>Notice: Please discuss project requirements and budget with the client before sending an offer to prevent misunderstandings.</p>
    <p>Notice: If pay by milestone you can skip description section</p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
                            ...
                            <div class="offer_total_price mt-5 setup-bank-form-item setup-bank-form-item-icon">
                                <labe><strong>Offer Price</strong></labe>
                                <input type="number" class="form-control" name="offer_price" id="offer_price" placeholder="Enter Price">
                            ...
                            <div class="d-flex flex-wrap gap-4 mb-4">
                                ...
                                <div id="pay_at_once_btn" class="identity-verifying-list active">
                                    <strong>Pay at Once</strong>
                                    <span>You will get the amount after complete the job.</span>
                                </div>

                                <div id="pay_by_milestone_btn" class="identity-verifying-list">
                                    <strong>Pay by Milestones</strong>
                                    <span>You will get the amount after complete each milestone.</span>
                                </div>
                            ...
                            <div class="description_wrapper">
                                <div class="row g-4">
                                    <div class="col-sm-6">
                                        <div class="single-input">
                                            <label class="label-title">Revision</label>
                                            <input type="number" min="1" max="200" class="form-control" name="offer_revision" id="offer_revision" placeholder="Enter Revision">
                                        </div>
                                    </div>

                                    <div class="col-sm-6">
                                        <div class="single-input">
                                            <div class="single-input set_dead_line">
    <label class="label-title">Delivery Time</label>
    <select name="offer_deadline" id="offer_deadline" class="form-control ">
        ...
        <option value="More than 3 month">More than 3 month</option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="single-input">
                                            ...
                                            <textarea name="offer_description" id="offer_description" rows="5" class="form-control summernote" placeholder="Enter a description"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="myJob-wrapper-single milestone_wrapper d-none">
                                <div class="myJob-wrapper-single-header profile-border-bottom">
                                    <h4 class="myJob-wrapper-single-title">Milestone</h4>
                                </div>
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-12">
                                                        <div class="single-input">
                                                            ...
                                                            <input type="text" class="form-control milestone_title" name="milestone_title[]" placeholder="Enter Title">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="single-input">
                                                            <label class="label-title">Description</label>
                                                            <textarea cols="30" rows="5" class="form-control milestone_description" name="milestone_description[]" placeholder="Enter Description"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="single-input">
                                                            <label class="label-title">Price</label>
                                                            <input type="number" class="form-control milestone_price" name="milestone_price[]" placeholder="Enter Price">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="single-input">
                                                            <label class="label-title">Revision</label>
                                                            <input type="number" min="1" max="100" class="form-control milestone_revision" name="milestone_revision[]" placeholder="Enter Revision">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="single-input">
                                                            <div class="single-input">
    <label class="label-title">Delivery Time</label>
    <select name="milestone_deadline[]" id="duration" class="form-control milestone_deadline set_dead_line ">
        <option value="">Select Delivery Time</option>
        <option value="1 Days">1 Days</option>
        <option value="2 Days">2 Days</option>
        <option value="3 Days">3 Days</option>
        ...
        <option value="More than 3 month">More than 3 month</option>
                                        ...
                                        <div class="btn-wrapper remove-milestone-contractor mt-4">
                                            <a href="#" class="btn-profile btn-bg-cancel">Remove</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-wrapper mt-4">
                                    <a href="javascript:void(0)" class="btn-profile btn-outline-gray add-contract-milestone"><i class="fa-solid fa-plus"></i>Add Milestone</a>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn-profile btn-bg-1 send_offer_realtime_validation">Send Offer</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <audio id="chat-alert-sound" style="display: none">
            <source src="https://xilancer.xgenious.com/assets/uploads/chat_image/sound/facebook_chat.mp3" />
        </audio>
    </main>
<!-- footer area start -->
...
<!--page script-->
    <script src="https://xilancer.xgenious.com/assets/common/js/helpers.js"></script>
    <script>
        let client_list = { client_id_1: false,client_id_2: false,client_id_407: false,client_id_450: false,client_id_486: false,client_id_519: false,client_id_532: false,client_id_568: false,client_id_631: false,client_id_637: false,client_id_638: false,client_id_660: false };
    </script>
...
<script>
    class LiveChat {
        ...
        constructor() {
            this.appKey ="35d552c7ae21f2547549";
            this.appCluster ="ap2";
            this.appUrl ="https://xilancer.xgenious.com";
    ...
    */
    ...
    $(document).on("click","#freelancer-send-message-to-client", function (){
        ...
        form.append('_token', "QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi");
        ...
        let messages_ = $('#freelancer-message-footer #message').val();
            ...
            let module_exits = "1"
            if(module_exits){
                let words = JSON.parse('["@gmail","account number","@email"]');
        ...
        if(messages_ != '' || file !== undefined){
            ...
            send_ajax_request("post", form, "https://xilancer.xgenious.com/freelancer/live/message-send", function (){}, function (response){
                $("#chat_body").append(response);
                if(response.status == 'image_not_allow_in_demo'){
                    toastr_warning_js("This is demonstration purpose only, you may not able to send files in demo purpose, once your purchase this script you will get access to all settings.");
                }
                scrollToBottom();
            }, function (){})
        }else{
    ...
    function fetch_chat_data(client_id, page = 1, callback){
        ...
        formData.append("_token", "QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi");
        formData.append("from_user", 2)

        send_ajax_request("post", formData,`https://xilancer.xgenious.com/freelancer/live/fetch-chat-client-record?page=${page}`,function (){
            ...
            if(page > 1) {
                ...
                let loadmore = `
                            <div class="pagination d-flex justify-content-center mb-3">
                                <button data-page="1" class="btn btn-info load-more-pagination">Load More</button>
                            </div>`;
    ...
    <script>
        ...
        $(document).on('click','.send_offer_realtime_validation',function(){
            ...
            if(offer_price == ''){
                toastr_warning_js("Please fill price field")
                return false;
            }
            ...
            if(pay_by_milestone == 'pay-by-milestone'){
                ...
                if(offer_price != total_milestone_price){
                    toastr_warning_js("Total milestone price must be equal to offer price")
                    return false;
                }
