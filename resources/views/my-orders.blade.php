        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-contents">
                    <h4 class="breadcrumb-contents-title"> My Orders </h4>
                    <ul class="breadcrumb-contents-list list-style-none">
                        <li class="breadcrumb-contents-list-item"> <a href="/freelancelo" class="breadcrumb-contents-list-item-link"> Home  </a> </li>
                        <li class="breadcrumb-contents-list-item"> My Orders </li>
                    </ul>
                </div>
            </div>
        </div>
...
<button class="order_sort" data-val="cancel">
    Cancelled <span>(20) </span>
</button>
<button class="order_sort" data-val="complete">
    Completed <span>(19) </span>
</button>
...
<input type="hidden" id="set_order_type_value" value="all">
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000581</span>
                        ...
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Complete Order</span>
                                                                                                    </div>
                    </div>
                ...
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$60.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
                                        <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            ...
                            <h6 class="myOrder_single__block__title mt-2">1 Days </h6>                        </div>
                    </div>
                                        <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-author">
                            <a href="javascript:void(0)">
                    <img src="https://xilancer.xgenious.com/assets/uploads/profile/1680500462-642a66ee548e7.jpg" alt="AuthorImg">
            </a>
                        </div>
                        <div class="myOrder-single-block-item-content">
                                    <span class="myOrder-single-block-subtitle">Customer</span>
                         <i class="fas fa-circle-check"></i>        
        <h6 class="myOrder-single-block-title mt-1">Andrew Fateh
                            <span class="single-freelancer-author-status-ofline"> Inactive </span>
                                </h6>
    </div>
                    </div>
                </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                                                                                                                                                                <a href="" class="btn-profile btn-outline-gray">Invoice</a>
                                <a href="" class="btn-profile btn-outline-gray">Submit Review</a>
                                                                                <a href="" class="btn-profile btn-bg-1">View Order</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000580</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="#"> Qixer service provider buyer mobile appp </a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Queue Order</span>
                                                                                                            </div>
                    </div>
                    <span class="myOrder-single-content-time">3 days ago </span>
                </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$40.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
        ...
        <h6 class="myOrder-single-block-title mt-1">Andrew Fateh
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    <div class="btn-wrapper">
                                                    <a tabindex="0" class="btn-profile btn-outline-cancel decline_and_change_order_status">Decline Order</a>
<form method='post' action='#' class="d-none">
    <input type='hidden' name='_token' value='QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi'>
    <input type='hidden' name='cancel_or_decline_order' value="decline">
    <br>
    <button type="submit" class="swal_form_submit_btn d-none"></button>
                    ...
                    <div class="btn-wrapper flex-btn">
                                                    <a tabindex="0" class="">Accept Order</a>
<form method='post' action='' class="d-none">
    <input type='hidden' name='_token' value='QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi'>
    <input type='hidden' name='cancel_or_decline_order' value="">
    <br>
    <button type="submit" class="swal_form_submit_btn d-none"></button>
</form>
                                                                            <a href="" class="btn-profile btn-bg-1">View Order</a>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000578</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="#">need a graphic designer</a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="job-progress">Active Order</span>
                                                                                </div>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        ...
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Delivery Time</span> <br>
                            <h6 class="myOrder_single__block__title mt-2">3 Days </h6>                        </div>
                    </div>
                                        <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-author">
                            <a href="javascript:void(0)">
        ...
        <h6 class="myOrder-single-block-title mt-1">Andrew Fateh
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                                                                                    <a tabindex="0" class="btn-profile btn-outline-cancel cancel_and_change_order_status">Cancel Order</a>
<form method='post' action='' class="d-none">
    <input type='hidden' name='_token' value='QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi'>
    <input type='hidden' name='cancel_or_decline_order' value="cancel">
    <br>
    <button type="submit" class="swal_form_submit_btn d-none"></button>
</form>
                                                                                                        <a href="" class="btn-profile btn-bg-1">View Order</a>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000577</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="">need a graphic designer</a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
...
<form method='post' action='#' class="d-none">
    ...
    <button type="submit" class="swal_form_submit_btn d-none"></button>
                    ...
                    <div class="btn-wrapper flex-btn">
                                                    <a tabindex="0" class="btn-profile btn-outline-gray accept_and_change_order_status">Accept Order</a>
<form method='post' action='#' class="d-none">
    <input type='hidden' name='_token' value='QBz2I8EiJyZZ9UnkKlvqzITV597a2ERjYuMUclOi'>
    <input type='hidden' name='cancel_or_decline_order' value="">
    <br>
    <button type="submit" class="swal_form_submit_btn d-none"></button>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000576</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="">need a graphic designer</a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
    ...
    <button type="submit" class="swal_form_submit_btn d-none"></button>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000575</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href="#"> I will build responsive WordPress website design and ecommerce website </a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Cancel Order</span>
                                                                                                </div>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$0.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
                        ...
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Delivery Time</span> <br>
                            <h6 class="myOrder_single__block__title mt-2">Less than a week </h6>                        </div>
                    </div>
                                        <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-author">
                            <a href="javascript:void(0)">
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000574</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            Custom order
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Cancel Order</span>
                                            <a href="javascript:void(0)" class="custom-order">Custom Order</a>
                                                    </div>
                    </div>
                    <span class="myOrder-single-content-time">1 week ago </span>
                </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$155.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000573</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            Custom order
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$11.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
    ...
    <button type="submit" class="swal_form_submit_btn d-none"></button>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000569</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            <a href=""> I will develop a books shop website using PHP, Laravel or WordPress </a>
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="pending-approval">Cancel Order</span>
                                                                                                </div>
                    </div>
                    <span class="myOrder-single-content-time">3 weeks ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$550.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#000566</span>
                        <h4 class="myOrder-single-content-title mt-2">
                                                            Custom order
                                                    </h4>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                                                            <span class="myOrder-single-block-subtitle">Order budget</span>
                                <h6 class="myOrder-single-block-title mt-2">$10.00
                                    <span class="myJob-wrapper-single-fixed active">Funded</span>
                                </h6>
                                                    </div>
                    </div>
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                {{-- <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=2">2</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=3">3</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=4">4</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=5">5</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=6">6</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=7">7</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=8">8</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=9">9</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=10">10</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=11">11</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/order/all?page=12">12</a></li> --}}
                        ...
                        <div class="profile-details-widget sticky_top">
                            <div class="file-wrapper-item-flex flex-between align-items-center profile-border-bottom">
                                ...
                                <a href="/posted-jobs" class="profile-wrapper-item-browse-btn"> Browse All </a>
                                        ...
                                        <h4 class="single-jobs-title">
                                            <a href="#">
                                                Job post as a client by freelancer
                                            </a>
                                        </h4>
                                        <p class="single-jobs-date">
                                            Oct 9, 2024 -
                                        ...
                                        <h4 class="single-jobs-title">
                                            <a href="#">
                                                E-Commerce Store Project in Laravel and VueJS 3 for hourly basis
                                            </a>
                                        </h4>
                                        <p class="single-jobs-date">
                                            Aug 31, 2024 -
                                        ...
                                        <h4 class="single-jobs-title">
                                            <a href="#">
                                                I need a highly experienced laravel developer for hourly basis
                                            </a>
                                        </h4>
                                        <p class="single-jobs-date">
                                            Aug 31, 2024 -
    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.accept_and_change_order_status',function(e){
                ...
                Swal.fire({
                    title: 'Accept Order ?',
                    text: 'You would not change it again.',
                    icon: 'warning',
            ...
            $(document).on('click','.submit_order_details',function(e){
                ...
                if(attachment == '' || description == ''){
                    toastr_warning_js("Please fill both fields");
                    return false;
                }
            });
            ...
            $(document).on('click','.order_sort',function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/order/sort/by/type",
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/order/paginate/data?page=" + page,
                    data:{order_type:order_type},
                    success:function(res){
                        $('.search_result').html(res);
                    }
