    ...
    <div class="container custom-container-one">
        ...
        <div class="profile-area pat-100 pab-100 section-bg-2">
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00035</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item not_seen">Not Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
                                                    </div>
                    </div>
                    <span class="myOrder-single-content-time">3 days ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$1,000.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                            <div class="myOrder-single-block-item-content">
                                <span class="myOrder-single-block-subtitle">Delivery Time</span> <br>
                                <h6 class="myOrder_single__block__title mt-2">
                                    2 Days
                                        ...
                                        <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Create Date</span><br>
                            <h6 class="myOrder_single__block__title mt-2">
                                Oct 24, 2024
                            </h6>
                        </div>
                ...
                <p class="mt-4">I&#039;ll be there bjchfhfhdhfchchfhfhfhfhfhfhfhfhfhfjfjchcjcjcjfjcjfhgjcdhjdjsjjsjsjsjjsjsjsjsjjsjsjxjdjdjdjdjhdhxhzhdjosjdjdjfhfjfjfjg</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-cover-letter="I&#039;ll be there bjchfhfhdhfchchfhfhfhfhfhfhfhfhfhfjfjchcjcjcjfjcjfhgjcdhjdjsjjsjsjsjjsjsjsjsjjsjsjxjdjdjdjdjhdhxhzhdjosjdjdjfhfjfjfjg"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00034</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item seen">Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
                                                            <span class="shortlisted-item seen">Interviewed</span>
                                                    </div>
                    </div>
                    <span class="myOrder-single-content-time">5 days ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$50.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                        ...
                        <div class="myOrder-single-block-item-content">
                            ...
                            <div class="myJob-wrapper-single-contents">
                                                                <a href="#" download class="single-refundRequest-item-uploads">
                ...
                <p class="mt-4">hide the same link Because my client want first to see this 80k order 3k Hadaa diyaar tahay soo qor magaca profile kaga lagugu qorayo noso dir fadlan noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga pa...</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="hide the same link Because my client want first to see this 80k order 3k Hadaa diyaar tahay soo qor magaca profile kaga lagugu qorayo noso dir fadlan noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga page kaga noso dir linkiga page kaga noso dir"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00033</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item not_seen">Not Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
                    ...
                    <span class="myOrder-single-content-time">1 week ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                ...
                <p class="mt-4">hi testhdhdhdhdhjdhsjdjdjdhhdjdjdhdjjdhdjdjdjxjxjjxjdjdjdjdjdnndjdjdjdjdjdjjdjdjdjdjdjfjjfjfjfjfjrjsiidhdhrhdidhdhjsidhrhdixhdhjzdhdidojdjridjxjdjdidjdjdjdjdjd</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="hi testhdhdhdhdhjdhsjdjdjdhhdjdjdhdjjdhdjdjdjxjxjjxjdjdjdjdjdnndjdjdjdjdjdjjdjdjdjdjdjfjjfjfjfjfjrjsiidhdhrhdidhdhjsidhrhdixhdhjzdhdidojdjridjxjdjdidjdjdjdjdjd"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00032</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item seen">Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$5.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">1⁰hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhyyyyyyyyyyyyyyyyyyyyyyyýyyxggggggggyyyyyyy
                ...
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="1⁰hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhyyyyyyyyyyyyyyyyyyyyyyyýyyxggggggggyyyyyyy
...
hdjdjdjeeu"
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00031</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item seen">Seen</span>
                            <div class="job-proposal-btn-item">
                                <span class="shortlisted-item hired">Hired</span>
                            </div>
                                                            <span class="shortlisted-item seen">Interviewed</span>
                                                    </div>
                    </div>
                    <span class="myOrder-single-content-time">2 weeks ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$100.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">I&#039;ll do it easily and let discuss further, I&#039;ll do it easily and let discuss further,I&#039;ll do it easily and let discuss further</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="I&#039;ll do it easily and let discuss further, I&#039;ll do it easily and let discuss further,I&#039;ll do it easily and let discuss further"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00029</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item not_seen">Not Seen</span>
                            <div class="job-proposal-btn-item">
                                <span class="shortlisted-item">Shortlisted</span>
                            </div>
                                                    </div>
                    </div>
                    <span class="myOrder-single-content-time">2 weeks ago </span>
            ...
            <div class="myOrder-single-item">
                ...
                <p class="mt-4">fhghj hhjjhhhh hjgkhk  jjgjjhhjj hdgjghjjj ihcjkjj jjcjkjnn jhcjbbifncjfh jjgjjnvjihn goggjiyhjjggjk hukbvb</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="fhghj hhjjhhhh hjgkhk  jjgjjhhjj hdgjghjjj ihcjkjj jjcjkjnn jhcjbbifncjfh jjgjjnvjihn goggjiyhjjggjk hukbvb"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00028</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item not_seen">Not Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$3,000.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">hi there ahshsjbsjs zjsjshvdjdvxjdvxjdbd idbd xidbxkdbd xkxbd xbkdkos xjdbzikjxxnxks zixbbx  ushdjdjsixjdhdhxjiihdhjs</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="hi there ahshsjbsjs zjsjshvdjdvxjdvxjdbd idbd xidbxkdbd xkxbd xbkdkos xjdbzikjxxnxks zixbbx  ushdjdjsixjdhdhxjiihdhjs"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00027</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item not_seen">Not Seen</span>
                            <div class="job-proposal-btn-item">
                                <span class="shortlisted-item hired">Hired</span>
                    ...
                    <span class="myOrder-single-content-time">1 month ago </span>
                </div>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$1.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">vhjjgf fghjk jkkkhh jkkhvvh jjvvcdf jjjfxdg jkhddg bjjgcb bjjgvhj. kkkhvj kjvchn njgggfb kkkhvj. ghjjhcghjjv hhggghb jhcxdgj kjgddghjk iifdfgj nhcgjkkkhc nkghkkgb nhhjn hgjv bhkjv nhhjn nkhbm nvbn. jnvv. jhkm jhcgjkbh jkvhjkb.</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="vhjjgf fghjk jkkkhh jkkhvvh jjvvcdf jjjfxdg jkhddg bjjgcb bjjgvhj. kkkhvj kjvchn njgggfb kkkhvj. ghjjhcghjjv hhggghb jhcxdgj kjgddghjk iifdfgj nhcgjkkkhc nkghkkgb nhhjn hgjv bhkjv nhhjn nkhbm nvbn. jnvv. jhkm jhcgjkbh jkvhjkb."
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00026</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item seen">Seen</span>
                            <div class="job-proposal-btn-item">
                                <span class="shortlisted-item">Shortlisted</span>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$5,000.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">this ghhgf hhhff hhhh thgf thggff ggfffg hhgggu uuhugf hhhhh hhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhh...</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="this ghhgf hhhff hhhh thgf thggff ggfffg hhgggu uuhugf hhhhh hhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh hhhhhh hhhhhhhh"
                        >
                            Proposal Details
                        </button>
                    </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex">
                    <div class="myOrder-single-content">
                        <span class="myOrder-single-content-id">#00025</span>
                        <div class="myOrder-single-content-btn flex-btn mt-3">
                            <span class="shortlisted-item seen">Seen</span>
                            <div class="job-proposal-btn-item">
                                                            </div>
            ...
            <div class="myOrder-single-item">
                <div class="myOrder-single-block">
                    <div class="myOrder-single-block-item">
                        <div class="myOrder-single-block-item-content">
                            <span class="myOrder-single-block-subtitle">Offer Price</span>
                            <h6 class="myOrder-single-block-title mt-2">$25.00
                            </h6>
                        </div>
                    </div>
                                            <div class="myOrder-single-block-item">
                ...
                <p class="mt-4">test test test testtetststststsgshfkkdkskskkrkfkfkkskskfnfkfkkddmfnglglgkdbsbdfkflskkskfkfkdkdnsnsndnfkfkkfkxxkdkndnfnfkflglgldkddnnd</p>
            </div>
            <div class="myOrder-single-item">
                <div class="myOrder-single-flex flex-between">
                    ...
                    <div class="btn-wrapper flex-btn">
                        <button
                           ...
                           data-bs-target="#CoverLetterModal"
                           data-bs-toggle="modal"
                           data-cover-letter="test test test testtetststststsgshfkkdkskskkrkfkfkkskskfnfkfkkddmfnglglgkdbsbdfkflskkskfkfkdkdnsnsndnfkfkkfkxxkdkndnfnfkflglgldkddnnd"
                        >
                            Proposal Details
                        </button>
                    </div>
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                {{-- <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/proposal/all?page=2">2</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/proposal/all?page=3">3</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://xilancer.xgenious.com/freelancer/proposal/all?page=4">4</a></li> --}}
                    ...
                    <a class="page-link" href="#" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                        ...
                        <div class="profile-details-widget sticky_top">
                            <div class="file-wrapper-item-flex flex-between align-items-center profile-border-bottom">
                                <h4 class="profile-wrapper-item-title"> Available Jobs </h4>
                                <a href="/posted-jobs" class="profile-wrapper-item-browse-btn"> Browse All </a>
                            </div>
                                                                                                                                        <div class="single-jobs border-0 radius-10 bg-white mt-4">
                                            <h4 class="single-jobs-title">
                                                <a href="#">need a graphic designer</a>
                                            </h4>
                                            ...
                                            <h3 class="single-jobs-price">
                                                $100.00
                                                <span class="single-jobs-price-fixed">Fixed</span>
                                            </h3>
                                            <div class="single-jobs-tag mt-4">
                                                                                                    <a href="#" class="single-jobs-tag-link">
                                                        Graphic Design </a>
                                                                                            </div>
                                        </div>
                                                                            <div class="single-jobs border-0 radius-10 bg-white mt-4">
                                            ...
                                            <div class="single-jobs-tag mt-4">
                                                                                                    <a href="#" class="single-jobs-tag-link">
                                                        Firebase on Android </a>
                                                                                            </div>
                                        </div>
                                                                            <div class="single-jobs border-0 radius-10 bg-white mt-4">
                                            <h4 class="single-jobs-title">
                                                <a href="#">Job post as a client by freelancer</a>
                                            </h4>
                                            <p class="single-jobs-date">
                                                Oct 9, 2024 -
                                                <span>Senior</span>
                                            ...
                                            <div class="single-jobs-tag mt-4">
                                                        ...
                                                        Php </a>
                                                                            ...
                                                                            <div class="single-jobs border-0 radius-10 bg-white mt-4">
                                            <h4 class="single-jobs-title">
                                                <a href="#">E-Commerce Store Project in Laravel and VueJS 3 for hourly basis</a>
                                            </h4>
                                            <p class="single-jobs-date">
                                                Aug 31, 2024 -
                                                <span>Junior</span>
                                            ...
                                            <h3 class="single-jobs-price">
                                                $30.00
                                                <span class="single-jobs-price-fixed">Hourly</span>
                                            </h3>
                                            <div class="single-jobs-tag mt-4">
                                                                                                    <a href="#" class="single-jobs-tag-link">
                                                        Firebase on Android </a>
                                                        ...
                                                        Javascript </a>
                                                                            ...
                                                                            <div class="single-jobs border-0 radius-10 bg-white mt-4">
                                            <h4 class="single-jobs-title">
                                                <a href="#">I need a highly experienced laravel developer for hourly basis</a>
                                            </h4>
                                            <p class="single-jobs-date">
                                                Aug 31, 2024 -
                                                <span>Not mandatory</span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="proposal_cover_letter_details"></p>
            </div>
        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                function subscriptions(page){
                    $.ajax({
                        url:"https://xilancer.xgenious.com/freelancer/proposal/paginate/data?page=" + page,
                        success:function(res){
