            ...
            <div class="setup-header setup-top-border">
                <div class="setup-header-flex">
                    <div class="setup-header-left">
                        <h4 class="setup-header-title">Setup Your Account</h4>
                    </div>
                    <div class="setup-header-right">
                        <a href="" class="setup-header-skip">Skip</a>
                    </div>
                </div>
            </div>
            ...
            <ul class="single-setup-request-list list-style-none">
                <li class="single-setup-request-list-item running">
                    ...
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title"> Introduction </h5>
                        <p class="single-setup-request-list-item-contents-para"> How do you professionally introduce yourself? </p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    <span class="single-setup-request-list-item-number"> 2 </span>
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">Experience </h5>
                        <p class="single-setup-request-list-item-contents-para">Let clients know about your professional experiences. </p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    <span class="single-setup-request-list-item-number"> 3 </span>
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">Education  </h5>
                        <p class="single-setup-request-list-item-contents-para">How do you professionally introduce yourself?</p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    ...
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">Work </h5>
                        <p class="single-setup-request-list-item-contents-para">Add the services and necessary skills you offer. </p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    <span class="single-setup-request-list-item-number"> 5 </span>
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">Skills  </h5>
                        <p class="single-setup-request-list-item-contents-para">Add the services and necessary skills you offer.</p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    <span class="single-setup-request-list-item-number"> 6 </span>
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">Hourly Rate &amp; Photo</h5>
                        <p class="single-setup-request-list-item-contents-para">Just add your Hourly Rate and Profile Photo to finish.</p>
                    </div>
                </li>
            </ul>
        </div>
...
<div class="setup-wrapper-contents active">
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">Tell us what professional title describes you? </h3>
        <div class="setup-wrapper-contents-form">
            <form action="#">
                <div class="setup-wrapper-contents-form-item">
                    <input type="text" name="title" id="title"  value="Laravel Developer"  class="form--control" placeholder="Enter Your Title">
                </div>
            </form>
        </div>
    </div>
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">Provide an intro about yourself</h3>
        <div class="setup-wrapper-contents-form">
            <form action="#">
                <div class="setup-wrapper-contents-form-item">
                    <textarea name="description" id="description" class="form-message" cols="30" rows="3" placeholder="I am a professional develop..."> I am a professional web developer work experience with 5 years. I will able to develop your any business  with laravel. </textarea>
                </div>
            </form>
        </div>
    </div>
...
<div class="setup-wrapper-contents">
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">Tell us about your professional experiences(Experience)</h3>
        <div class="setup-wrapper-experience">
            <div class="setup-wrapper-experience-add">
                <span class="setup-wrapper-experience-add-title">Add a work experience</span>
    ...
    <div class="setup-wrapper-contents-item" id="display_user_experience_data">
        <h4 class="setup-wrapper-contents-title-two">Work experience </h4>
                    <div class="setup-wrapper-experience">
...
<div class="setup-wrapper-contents">
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">What’s your Educational Background?(Education)</h3>
        <div class="setup-wrapper-experience">
            <div class="setup-wrapper-experience-add">
                <span class="setup-wrapper-experience-add-title">Add a Educational Background</span>
                <a href="javascript:void(0)" class="setup-wrapper-experience-add-icon add-education"> <i class="fas fa-plus"></i> </a>
            </div>
        </div>
    </div>
    <div class="setup-wrapper-contents-item">
        <h4 class="setup-wrapper-contents-title-two">Education</h4>
...
<div class="popup-fixed education-popup">
    ...
    <div class="single-input">
        ...
        <div class="popup-contents-btn flex-btn justify-content-end profile-border-top">
            <a href="javascript:void(0)" class="btn-profile btn-outline-gray btn-hover-danger popup-close"> <i class="las la-arrow-left"></i>Cancel</a>
            <a href="javascript:void(0)" class="btn-profile btn-bg-1 update_single_education">Save</a>
        </div>
    </div>
</div>
<!-- Edit Education Ends  -->
...
<div class="setup-wrapper-contents">
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">What kinds of services will you provide to clients?(Work)</h3>
        <div class="setup-wrapper-work">
            <div class="row g-4">
                <input type="hidden" id="set_category_id"  value="18" >
                <input type="hidden" id="set_sub_category_id"  value="22" >
                                <div class="col-md-4 col-sm-6 setup-work-child work_category_id">
                    <input type="hidden" value="1">
                    <div class="setup-wrapper-work-single center-text   ">
                        <div class="setup-wrapper-work-single-icon">
                            <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s11676182965.svg"  alt=""/>
                        </div>
                        <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Design and Creative</a> </h4>
                    </div>
                </div>
                                <div class="col-md-4 col-sm-6 setup-work-child work_category_id">
                    ...
                    <div class="setup-wrapper-work-single center-text   ">
                        <div class="setup-wrapper-work-single-icon">
                            <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s21676183067.svg"  alt=""/>
                        </div>
                        <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Website Development</a> </h4>
                    </div>
                </div>
                                <div class="col-md-4 col-sm-6 setup-work-child work_category_id">
                    ...
                    <div class="setup-wrapper-work-single center-text   ">
                        <div class="setup-wrapper-work-single-icon">
                            <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s31676183272.svg"  alt=""/>
                        </div>
                        <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Customer Service</a> </h4>
                    </div>
                </div>
                                <div class="col-md-4 col-sm-6 setup-work-child work_category_id">
                    ...
                    <div class="setup-wrapper-work-single center-text   ">
                        <div class="setup-wrapper-work-single-icon">
                            <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s41676183896.svg"  alt=""/>
                        </div>
                        <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Mobile App Development</a> </h4>
                    </div>
                </div>
                                <div class="col-md-4 col-sm-6 setup-work-child work_category_id">
                    ...
                    <div class="setup-wrapper-work-single center-text   ">
                        <div class="setup-wrapper-work-single-icon">
                            <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s51676183967.svg"  alt=""/>
                        </div>
                        <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Education &amp; Teachings</a> </h4>
                    </div>
                </div>
                    ...
                    <div class="setup-wrapper-work-single center-text work-click">
                        ...
                        <h4 class="setup-wrapper-work-single-title"> Categories to choose from </h4>
                    </div>
                </div>
    ...
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title-two"> Choose, what would you do? </h3>
        <ul class="setup-wrapper-work-list get_subcategory">
            <li class="setup-wrapper-work-list-item get_subcategory choose_a_subcategory  active ">Backend Developer </li>
        </ul>
    </div>
</div>
...
<div class="popup-fixed work-popup">
    <div class="popup-contents">
        <span class="popup-contents-close popup-close"> <i class="fas fa-times"></i> </span>
        <h2 class="popup-contents-title">Choose a service</h2>
        <p class="popup-contents-para">Choose what kinds of services will you provide to clients?</p>
        <div class="popup-contents-form custom-form">
            <form action="#">
                <div class="single-input single-input-icon">
                    <input type="text" class="form--control" id="category_search_string" placeholder="Search service">
        ...
        <div class="setup-wrapper-work-single center-text   ">
            <div class="setup-wrapper-work-single-icon">
                <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s61676184022.svg"  alt=""/>
            </div>
            <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Research</a> </h4>
        </div>
    </div>
    <div class="col-lg-4 col-sm-6 setup-work-child work_category_id">
        ...
        <div class="setup-wrapper-work-single center-text   ">
            <div class="setup-wrapper-work-single-icon">
                <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/account_s81676184135.svg"  alt=""/>
            </div>
            <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Digital Marketing</a> </h4>
        </div>
    </div>
    <div class="col-lg-4 col-sm-6 setup-work-child work_category_id">
        ...
        <div class="setup-wrapper-work-single center-text   ">
            ...
            <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Writing and Translation</a> </h4>
        </div>
    </div>
    <div class="col-lg-4 col-sm-6 setup-work-child work_category_id">
        ...
        <div class="setup-wrapper-work-single center-text   ">
            <div class="setup-wrapper-work-single-icon">
                <img src="https://xilancer.xgenious.com/assets/uploads/media-uploader/Skills1701170646.svg"  alt=""/>
            </div>
            <h4 class="setup-wrapper-work-single-title"> <a href="javascript:void(0)">Website Design</a> </h4>
        </div>
    </div>
        </div>
        <div class="popup-contents-btn flex-btn justify-content-end profile-border-top">
...
<div class="setup-wrapper-contents">
    <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title"> Great! Now add some skills you have </h3>
...
<div class="setup-wrapper-contents">
        <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">What is your hourly rate?</h3>
        ...
        <div class="setup-wrapper-contents-item">
        <h3 class="setup-wrapper-contents-title">Upload profile photo</h3>
        <div class="setup-wrapper-finish">
            <div class="setup-wrapper-finish-profile">
                <div class="setup-wrapper-finish-profile-flex">
                    ...
                    <div class="setup-wrapper-finish-profile-content">
                        <span class="cmn-btn btn-bg-1 btn-small hourly-rate-btn"> Upload Photo <input type="file" id="upload_profile_photo"> </span>
                        <p class="setup-wrapper-finish-profile-content-para"> Profile photo should be minimum 120x120 pixels </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary save_profile_photo">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    (function ($) {
        ...
        $(document).ready(function () {
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            ...
                            if(all_subcategories.length <= 0){
                                $(".get_subcategory").html('<span class="text-danger"> No subcategory found for selected category! <span>');
            ...
            $(document).on('keyup','#category_search_string', function (){
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/account/search-category",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
                        if(res.status=='nothing'){
                            $('.search_result').html('<h5 class="text-center text-danger">'+"Nothing Found"+'</h5>');
                        }else{
            ...
            $(document).on('submit','#profilePhotoUploadForm', function(e) {
                ...
                $.ajax({
                    url:"https://xilancer.xgenious.com/freelancer/account/upload-profile-photo",
                    method:'post',
                ...
                if (current <= Listings.length - 1) {
                    ...
                    if(current == 1){
                        ...
                        if(title == '' || description == ''){
                            current = 0;
                            toastr_warning_js("Please fill title and description !");
                            return false;
                        }else if(description.length >250){
                            toastr_warning_js("Description must not greater than 250 charecter !");
                            return false;
                        }else{
                            $.ajax({
                                url: "https://xilancer.xgenious.com/freelancer/account/add-introduction",
                                type: 'post',
                                data: {title: title,description:description},
                                success: function(res){
                                    if(res.status == 'ok'){
                                        toastr_success_js("Introduction Successfully Updated");
                                    }
                                }
                            });
                        }
                    ...
                    // todo add work
                        ...
                        if(category == ''){
                            current = 3;
                            toastr_warning_js("Please choose a category !");
                            return false;
                        }else{
                            $.ajax({
                                url: "https://xilancer.xgenious.com/freelancer/account/add-work",
                                type: 'post',
                                data: {category: category,subcategory:subcategory},
                                success: function(res){
                                    if(res.status == 'ok'){
                                        toastr_success_js("Work Successfully Updated");
                                    }
                                }
                            });
                        }
                    ...
                    // todo add skill
                        ...
                        if(skill == ''){
                            current = 4;
                            toastr_warning_js("You must add one or more skills !");
                            return false;
                        }else{
                            $.ajax({
                    ...
                    // todo add hourly rate
                        ...
                        if(hourly_rate == ''){
                            current = 5;
                            toastr_warning_js("You must add hourly rate!");
                            return false;
                        }else{
                            $.ajax({
                                url: "https://xilancer.xgenious.com/freelancer/account/add-hourly-rate",
                                type: 'post',
                                data: {hourly_rate: hourly_rate},
                                success: function(res){
                                    if(res.status == 'ok'){
                                        toastr_success_js("Profile Photo Successfully Updated");
                                        let redirectPath = "https://xilancer.xgenious.com/freelancer/account/congrats";
